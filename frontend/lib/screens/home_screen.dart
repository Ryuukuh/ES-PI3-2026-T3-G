                        ...
                        return Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                _formatCurrency(ap['amount'] as double),
                                style: const TextStyle(fontWeight: FontWeight.bold),
                              ),
                            ],
                          ),
                ...
                children: [
                  ...
                  if (_isLoadingStartups)
                    ...
                    Container(
                      ...
                      child: const Text(
                        'Nenhuma startup encontrada no catálogo no momento.',
                        style: TextStyle(color: Colors.grey),
                      ),
                    )
                  else
